 ...
 * Set via app_build_config.h's APP_BUILD catalog (see
 * APP_BUILD_CAN_BUS_TEST_ORIGINATOR / _ECHO), or override either directly on
 * the compiler command line (e.g. -DCAN_BUS_TEST=1). */
#ifndef CAN_BUS_TEST
