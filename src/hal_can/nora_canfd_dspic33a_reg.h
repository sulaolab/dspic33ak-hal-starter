/**
 * @file    nora_canfd_dspic33a_reg.h
 ...
 *          public header. Only this file and nora_canfd_device_dspic33a.c know the
...
/* Interrupt-enable bits used only by the optional ISR layer (nora_canfd_isr_dspic33a.c). */
