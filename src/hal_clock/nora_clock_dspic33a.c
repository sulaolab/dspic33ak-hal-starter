...
#include "nora_clock_dspic33a.h"
#include "nora_clock_device.h"
#include "nora_clock_dspic33a_reg.h"
 ...
 * request construction; raw SFR access lives in nora_clock_dspic33a_reg.c.
 * -------------------------------------------------------------------------- */
    ...
    uint32_t input_hz)
{
    ...
    status = configure_clkgen(NORA_CLOCK_DSPIC33A_CLKGEN_1, source, 1u);
    ...
    const nora_clock_dspic33a_clkgen_config_t *config)
{
    ...
    if (clkgen == NORA_CLOCK_DSPIC33A_CLKGEN_1) {
