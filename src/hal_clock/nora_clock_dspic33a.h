#ifndef NORA_CLOCK_DSPIC33A_H
#define NORA_CLOCK_DSPIC33A_H
 ...
 *   entry point was AK-shaped. Naming them nora_clock_dspic33a_* puts the fact at
...
typedef enum {
    NORA_CLOCK_DSPIC33A_CLKGEN_1  = 1,
    NORA_CLOCK_DSPIC33A_CLKGEN_5  = 5,
    NORA_CLOCK_DSPIC33A_CLKGEN_6  = 6,
    NORA_CLOCK_DSPIC33A_CLKGEN_8  = 8,
    NORA_CLOCK_DSPIC33A_CLKGEN_9  = 9,
    NORA_CLOCK_DSPIC33A_CLKGEN_10 = 10,
    NORA_CLOCK_DSPIC33A_CLKGEN_12 = 12,
    ...
    NORA_CLOCK_DSPIC33A_CLKGEN_13 = 13
} nora_clock_dspic33a_clkgen_t;

typedef struct {
    nora_clock_source_t source;
    uint16_t divide_by;
} nora_clock_dspic33a_clkgen_config_t;
 ...
 */
nora_clock_status_t
nora_clock_dspic33a_clkgen_configure(
    nora_clock_dspic33a_clkgen_t clkgen,
    const nora_clock_dspic33a_clkgen_config_t *config);

#ifdef __cplusplus
}
#endif

#endif /* NORA_CLOCK_DSPIC33A_H */
