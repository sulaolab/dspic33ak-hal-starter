...
#ifndef NORA_DMA_DSPIC33A_FAST_H
#define NORA_DMA_DSPIC33A_FAST_H
 ...
 *   nora_dma_dspic33a_read_src() instead (as this header used to) forced the ISR
...
{
    const uint32_t mask = NORA_DMA_DSPIC33A_STAT_HALF |
                          NORA_DMA_DSPIC33A_STAT_DONE;
...
{
    return ((status & NORA_DMA_DSPIC33A_STAT_OVERRUN) != 0u);
}
...
#endif /* NORA_DMA_DSPIC33A_FAST_H */
