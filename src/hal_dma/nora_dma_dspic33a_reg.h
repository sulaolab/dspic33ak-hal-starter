...
#ifndef NORA_DMA_DSPIC33A_REG_H
#define NORA_DMA_DSPIC33A_REG_H
 ...
 * Those live as private helpers in nora_dma_dspic33a.c or, for measured
 * direct-SFR paths, nora_dma_dspic33a_fast.h.
 *
...
#define NORA_DMA_DSPIC33A_CON_ON             (1UL << 15)   /* DMACONbits.ON       */
#define NORA_DMA_DSPIC33A_BMX_INITPR_DMAPR   (1UL << 0)    /* BMXINITPRbits.DMAPR */

/* ---- DMA controller address window ---- */
#define NORA_DMA_DSPIC33A_ADDR_WINDOW_LOW    (0x00000100UL) /* -> DMALOW  */
#define NORA_DMA_DSPIC33A_ADDR_WINDOW_HIGH   (0x00FFFFFFUL) /* -> DMAHIGH */

/* ---- DMAxCH single-bit fields ---- */
#define NORA_DMA_DSPIC33A_CH_CHEN         (1UL << 0)    /* DMAxCHbits.CHEN    */
#define NORA_DMA_DSPIC33A_CH_HALFEN       (1UL << 1)    /* DMAxCHbits.HALFEN  */
#define NORA_DMA_DSPIC33A_CH_DONEEN       (1UL << 3)    /* DMAxCHbits.DONEEN  */
#define NORA_DMA_DSPIC33A_CH_RELOADS      (1UL << 24)   /* DMAxCHbits.RELOADS */
#define NORA_DMA_DSPIC33A_CH_RELOADD      (1UL << 25)   /* DMAxCHbits.RELOADD */
#define NORA_DMA_DSPIC33A_CH_RELOADC      (1UL << 26)   /* DMAxCHbits.RELOADC */

/* ---- DMAxCH multi-bit fields (position + mask) ---- */
#define NORA_DMA_DSPIC33A_CH_SIZE_POS     (6)           /* DMAxCHbits.SIZE   */
#define NORA_DMA_DSPIC33A_CH_SIZE_MASK    (0x3UL  << NORA_DMA_DSPIC33A_CH_SIZE_POS)
#define NORA_DMA_DSPIC33A_CH_TRMODE_POS   (10)          /* DMAxCHbits.TRMODE */
#define NORA_DMA_DSPIC33A_CH_TRMODE_MASK  (0x3UL  << NORA_DMA_DSPIC33A_CH_TRMODE_POS)
#define NORA_DMA_DSPIC33A_CH_DAMODE_POS   (12)          /* DMAxCHbits.DAMODE */
#define NORA_DMA_DSPIC33A_CH_DAMODE_MASK  (0x3UL  << NORA_DMA_DSPIC33A_CH_DAMODE_POS)
#define NORA_DMA_DSPIC33A_CH_SAMODE_POS   (14)          /* DMAxCHbits.SAMODE */
#define NORA_DMA_DSPIC33A_CH_SAMODE_MASK  (0x3UL  << NORA_DMA_DSPIC33A_CH_SAMODE_POS)

/* ---- DMAxSEL field ---- */
#define NORA_DMA_DSPIC33A_SEL_CHSEL_POS   (0)           /* DMAxSELbits.CHSEL */
#define NORA_DMA_DSPIC33A_SEL_CHSEL_MASK  (0xFFUL << NORA_DMA_DSPIC33A_SEL_CHSEL_POS)

/* ---- DMAxSTAT flags ---- */
#define NORA_DMA_DSPIC33A_STAT_OVERRUN    (1UL << 3)    /* DMAxSTATbits.OVERRUN */
#define NORA_DMA_DSPIC33A_STAT_HALF       (1UL << 4)    /* DMAxSTATbits.HALF    */
#define NORA_DMA_DSPIC33A_STAT_DONE       (1UL << 5)    /* DMAxSTATbits.DONE    */
