#ifndef NORA_I2C_DSPIC33A_DEVICE_H
#define NORA_I2C_DSPIC33A_DEVICE_H
 ...
 * definitions in nora_i2c_dspic33a_device.c for why these exist instead of an
...
#endif /* NORA_I2C_DSPIC33A_DEVICE_H */
