...
static const itc_list_regs_t itc_list_regs[NORA_ITC_LIST_COUNT] = {
    { &ITCLS0CON, &ITCLS0SEQ, &ITCLS0TMR, &ITCLS0STAT, &ITCLS0MUL },
    { &ITCLS1CON, &ITCLS1SEQ, &ITCLS1TMR, &ITCLS1STAT, &ITCLS1MUL },
    { &ITCLS2CON, &ITCLS2SEQ, &ITCLS2TMR, &ITCLS2STAT, &ITCLS2MUL },
};
