...
// INCLUDES
//===========================================================
#include "nora_spi_i2s_tdm_dspic33a_diag_fast.h"
...
#include "nora_dma.h"
#include "nora_dma_dspic33a_fast.h"  // dsPIC33A ISR diagnostic fast path
#include "nora_spi_i2s_tdm_dspic33a_reg.h" // NORA_SPI_I2S_TDM_STAT_* masks (note_errflags)
...
void nora_spi_i2s_tdm_dspic33a_sumprof_configure( uint32_t now, uint32_t window_period_ticks )
{
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.window_period_ticks = window_period_ticks;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.window_end_ticks    = now + window_period_ticks;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.busy_start_ticks    = now;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.busy_ticks          = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.max_busy_ticks      = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.saturated_count     = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.busy_depth          = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.initialized         = ( window_period_ticks != 0u );
}
...
void nora_spi_i2s_tdm_dspic33a_sumprof_reset( uint32_t now )
{
    ...
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.window_end_ticks = now + g_nora_spi_i2s_tdm_dspic33a_sumprof_state.window_period_ticks;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.busy_start_ticks = now;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.busy_ticks       = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.max_busy_ticks   = 0u;
    g_nora_spi_i2s_tdm_dspic33a_sumprof_state.saturated_count  = 0u;
                                             ...
                                             bool clear_peak )
{
    ...
    out->window_period_ticks = g_nora_spi_i2s_tdm_dspic33a_sumprof_state.window_period_ticks;
    out->max_busy_ticks      = g_nora_spi_i2s_tdm_dspic33a_sumprof_state.max_busy_ticks;
    out->saturated_count     = g_nora_spi_i2s_tdm_dspic33a_sumprof_state.saturated_count;
    out->initialized         = g_nora_spi_i2s_tdm_dspic33a_sumprof_state.initialized;
