#ifndef NORA_SPI_I2S_TDM_DSPIC33A_HW_H
#define NORA_SPI_I2S_TDM_DSPIC33A_HW_H
...
#define NORA_SPI_I2S_TDM_DSPIC33A_DEV_AK512   (1)
#define NORA_SPI_I2S_TDM_DSPIC33A_DEV_AK128   (2)

#if   defined(__dsPIC33AK512MPS512__)
  #define NORA_SPI_I2S_TDM_DSPIC33A_DEVICE \
      NORA_SPI_I2S_TDM_DSPIC33A_DEV_AK512
#elif defined(__dsPIC33AK128MC106__)
  #define NORA_SPI_I2S_TDM_DSPIC33A_DEVICE \
      NORA_SPI_I2S_TDM_DSPIC33A_DEV_AK128
#else
...
typedef enum {
    ...
    TDM_SPI4 = 3,
#endif // NORA_SPI_I2S_TDM_DSPIC33A_DEVICE == NORA_SPI_I2S_TDM_DSPIC33A_DEV_AK512
    TDM_SPI_INST_COUNT
} tdm_spi_inst_t;
...
#endif // NORA_SPI_I2S_TDM_DSPIC33A_HW_H
