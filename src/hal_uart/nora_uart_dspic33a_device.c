 ...
 * from nora_uart_dspic33a_get_device() and the internal priority setter functions.
 */
...
static const nora_uart_dspic33a_device_t g_uart_devices[NORA_UART_INST_COUNT] = {
#if defined(U1CON)
    [NORA_UART_INST_1] = {
        .present = true,
        .regs = {
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_get_device                                                  */
/* -------------------------------------------------------------------------- */
const nora_uart_dspic33a_device_t *nora_uart_dspic33a_get_device(
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_instance_is_present                                         */
/* -------------------------------------------------------------------------- */
bool nora_uart_dspic33a_instance_is_present(nora_uart_instance_t inst)
{
    return (nora_uart_dspic33a_get_device(inst) != 0);
}

/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_device_set_rx_irq_priority                                  */
/* -------------------------------------------------------------------------- */
bool nora_uart_dspic33a_device_set_rx_irq_priority(
    nora_uart_instance_t inst,
    uint8_t priority)
{
    switch (inst) {
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_device_set_tx_irq_priority                                  */
/* -------------------------------------------------------------------------- */
bool nora_uart_dspic33a_device_set_tx_irq_priority(
    nora_uart_instance_t inst,
    uint8_t priority)
{
    switch (inst) {
...
bool nora_uart_dspic33a_device_rx_irq_clear_flag(nora_uart_instance_t inst)
{
    switch (inst) {
#if defined(_U1RXIF)
...
bool nora_uart_dspic33a_device_rx_irq_enable(nora_uart_instance_t inst,
                                                  bool enable)
{
    switch (inst) {
#if defined(_U1RXIE)
...
bool nora_uart_dspic33a_device_rx_irq_is_enabled(nora_uart_instance_t inst,
                                                      bool *enabled)
{
    if (enabled == 0) {
        return false;
...
bool nora_uart_dspic33a_device_tx_irq_clear_flag(nora_uart_instance_t inst)
{
    switch (inst) {
#if defined(_U1TXIF)
...
bool nora_uart_dspic33a_device_tx_irq_raise_flag(nora_uart_instance_t inst)
{
    switch (inst) {
#if defined(_U1TXIF)
...
bool nora_uart_dspic33a_device_tx_irq_enable(nora_uart_instance_t inst,
                                                  bool enable)
{
    switch (inst) {
#if defined(_U1TXIE)
