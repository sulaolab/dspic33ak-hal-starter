 ...
 * (nora_uart_dspic33a_get_device) and the nora_uart_dspic33a_reg.h bit-mask helpers, so
 ...
 *   - g_rx_read_idx is advanced only by nora_uart_dspic33a_rx_isr_read_byte().
...
static volatile nora_uart_dspic33a_rx_isr_status_t g_rx_status[NORA_UART_INST_COUNT];
...
static const nora_uart_dspic33a_regs_t *uart_regs(nora_uart_instance_t inst);
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_config                                               */
/* -------------------------------------------------------------------------- */
nora_uart_status_t nora_uart_dspic33a_rx_isr_config(
    nora_uart_instance_t inst,
    const nora_uart_dspic33a_rx_isr_config_t *config)
{
    ...
    nora_uart_dspic33a_reg_clear(r->STAT, NORA_UART_DSPIC33A_STAT_RXWM);
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_enable                                               */
/* -------------------------------------------------------------------------- */
nora_uart_status_t nora_uart_dspic33a_rx_isr_enable(
    nora_uart_instance_t inst)
{
    if (!uart_inst_is_valid(inst)) {
        return NORA_UART_ERR_INVALID_ARG;
    ...
    if (!g_rx_isr_configured[inst]) {
         ...
         * nora_uart_dspic33a_rx_isr_config() succeeds, so report not-initialized. */
        return NORA_UART_ERR_NOT_INITIALIZED;
    }
    if (!nora_uart_is_initialized(inst)) {
        return NORA_UART_ERR_NOT_INITIALIZED;
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_disable                                              */
/* -------------------------------------------------------------------------- */
nora_uart_status_t nora_uart_dspic33a_rx_isr_disable(
    nora_uart_instance_t inst)
{
    if (!uart_inst_is_valid(inst)) {
        return NORA_UART_ERR_INVALID_ARG;
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_ready                                                */
/* -------------------------------------------------------------------------- */
bool nora_uart_dspic33a_rx_isr_ready(nora_uart_instance_t inst)
{
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_read_byte                                            */
/* -------------------------------------------------------------------------- */
nora_uart_status_t nora_uart_dspic33a_rx_isr_read_byte(
    nora_uart_instance_t inst,
    uint8_t *data)
{
    uint16_t read_idx;
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_flush                                                */
/* -------------------------------------------------------------------------- */
void nora_uart_dspic33a_rx_isr_flush(nora_uart_instance_t inst)
{
    const nora_uart_dspic33a_regs_t *r;
    uint8_t ie;
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_status_get                                           */
/* -------------------------------------------------------------------------- */
void nora_uart_dspic33a_rx_isr_status_get(
    nora_uart_instance_t inst,
    nora_uart_dspic33a_rx_isr_status_t *status)
{
    uint8_t ie;
...
/* -------------------------------------------------------------------------- */
/* nora_uart_dspic33a_rx_isr_status_clear                                         */
/* -------------------------------------------------------------------------- */
void nora_uart_dspic33a_rx_isr_status_clear(nora_uart_instance_t inst)
{
    uint8_t ie;
...
void nora_uart_rx_irq_handler(nora_uart_instance_t inst)
{
    ...
    while (!nora_uart_dspic33a_reg_is_set(r->STAT, NORA_UART_DSPIC33A_STAT_RXBE)) {
        ...
        if (!nora_uart_dspic33a_async_rx_feed(inst, b)) {
    ...
    if (nora_uart_dspic33a_reg_is_set(r->STAT, NORA_UART_DSPIC33A_STAT_FERIF)) {
        g_rx_status[inst].framing_error_count++;
        nora_uart_dspic33a_reg_clear(r->STAT, NORA_UART_DSPIC33A_STAT_FERIF);
        events |= NORA_UART_EVENT_RX_FRAMING_ERROR;
    }
    if (nora_uart_dspic33a_reg_is_set(r->STAT, NORA_UART_DSPIC33A_STAT_PERIF)) {
        g_rx_status[inst].parity_error_count++;
        nora_uart_dspic33a_reg_clear(r->STAT, NORA_UART_DSPIC33A_STAT_PERIF);
        events |= NORA_UART_EVENT_RX_PARITY_ERROR;
    }
    if (nora_uart_dspic33a_reg_is_set(r->STAT, NORA_UART_DSPIC33A_STAT_ABDOVIF)) {
        g_rx_status[inst].autobaud_overflow_count++;
        nora_uart_dspic33a_reg_clear(r->STAT, NORA_UART_DSPIC33A_STAT_ABDOVIF);
    }
    if (nora_uart_dspic33a_reg_is_set(r->STAT, NORA_UART_DSPIC33A_STAT_TXCIF)) {
        g_rx_status[inst].tx_collision_count++;
        nora_uart_dspic33a_reg_clear(r->STAT, NORA_UART_DSPIC33A_STAT_TXCIF);
    }
    ...
    if (events != 0u) {
        nora_uart_dspic33a_async_notify_events(inst, events);
    }
}
...
static const nora_uart_dspic33a_regs_t *uart_regs(nora_uart_instance_t inst)
{
    const nora_uart_dspic33a_device_t *dev = nora_uart_dspic33a_get_device(inst);
...
static bool uart_rx_irq_set_priority(nora_uart_instance_t inst, uint8_t prio)
{
    return nora_uart_dspic33a_device_set_rx_irq_priority(inst, prio);
}
...
static bool uart_rx_irq_clear_flag(nora_uart_instance_t inst)
{
    return nora_uart_dspic33a_device_rx_irq_clear_flag(inst);
}
