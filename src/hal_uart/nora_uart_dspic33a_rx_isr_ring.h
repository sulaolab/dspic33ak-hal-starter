#ifndef NORA_UART_DSPIC33A_RX_ISR_RING_H
#define NORA_UART_DSPIC33A_RX_ISR_RING_H
 ...
 *     nora_uart_dspic33a_rx_isr_ring.c.
 *
...
} nora_uart_dspic33a_rx_isr_config_t;
 ...
 *   - nora_uart_dspic33a_rx_isr_status_t   is accumulated runtime state / counters.
 */
typedef struct
{
...
} nora_uart_dspic33a_rx_isr_status_t;
 ...
 * interrupt is left DISABLED; call nora_uart_dspic33a_rx_isr_enable() to start it.
 *
 * Returns:
...
bool nora_uart_dspic33a_rx_isr_ready(
    nora_uart_instance_t inst);
...
void nora_uart_dspic33a_rx_isr_flush(
    nora_uart_instance_t inst);
...
void nora_uart_dspic33a_rx_isr_status_clear(
    nora_uart_instance_t inst);

/* ========================================================================== */
/* Internal HAL hooks                                                         */
/*                                                                            */
/* Glue between the RX ISR ring core (nora_uart_dspic33a_rx_isr_ring.c) and the    */
/* asynchronous transfer engine and its callback state (nora_uart_dspic33a.c).     */
/* The RX ISR handler above calls these; they are implemented in               */
/* nora_uart_dspic33a.c. Not part of the application-facing API.                   */
/* ========================================================================== */
 ...
 */
bool nora_uart_dspic33a_async_rx_feed(
    nora_uart_instance_t inst,
    uint8_t byte);
...
#endif /* NORA_UART_DSPIC33A_RX_ISR_RING_H */
